...
//
//   String plainText = 'asdasdfafd';
//
//   RSAPrivateKey pKay = RsaKeyHelper.parsePrivateKeyFromPem(privateKeyPem);
//
//   String encryptedMessage = RsaKeyHelper.encryptWithPublicKey(
//       plainText, keyPair.publicKey as RSAPublicKey);
//   // Decrypt the encrypted message with the private key
//   String decryptedMessage =
//       RsaKeyHelper.decryptWithPrivateKey(encryptedMessage, pub);
//   // Print results
